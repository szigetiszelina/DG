            ...
            <?php if($is_login){ ?>
                <div class="col-lg-3 col-md-4 col-sm-5">
                    <nav id="menu">
                          ...
                          ?>                
                          <a href="<?= $link_to ?>" class="button letter2 <?=($link_to==$current_url || ($current_url==base_url()."play" && $study_type == "exercise"))?'active_button':'' ?>" ><p>Gyakorolj</p></a>
                          <?php $link_to = base_url() ."games/evelove"; ?>
                          <a href="<?= $link_to ?>" class="button letter5 <?=($link_to==$current_url || ($current_url==base_url()."play" && $study_type == "evelove"))?'active_button':'' ?>" ><p>Fejlődj</p></a>
